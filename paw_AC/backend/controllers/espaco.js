...
exports.getEspaco = (req,res,next) => {
  res.sendFile(__dirname + 'C:\Users\nunof\Desktop\paw\src\app\espaco\criar-espaco\criar-espaco.component.html');
 };
...
exports.getListaReservas= (req,res,next) => {
  res.sendFile(__dirname + 'C:\Users\nunof\Desktop\paw\src\app\espaco\listagem-reservas\listagem-reservas.component.html');
 };
